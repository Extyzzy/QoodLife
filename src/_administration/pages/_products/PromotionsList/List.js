...
const List = ({
  ...
  <div className={s.root}>
    ...
    <h2>
      {I18n.t('administration.menuDropDown.product')}
        ...
        <div>
          {
            canManagePromotions && (
              <div className="pull-right mt-n-xs">
                <Link
                  to={`/administration/products/${productId}/promotions/create`}
                ...
                <DateTimeCell timestamp={createdAt} />
                {
                  canManagePromotions && (
                    <td style={{whiteSpace: 'nowrap'}}>
                      <Link
                        to={`/administration/products/${productId}/promotions/${id}/edit`}
                        className={
                          classes(
                            'btn btn-warning',
                            s.actionBtn
