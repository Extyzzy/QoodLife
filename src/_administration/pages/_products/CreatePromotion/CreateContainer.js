...
class CreateContainer extends Component {
  ...
  getInitialDataFetchers() {
    ...
    return [
      fetchApiRequest(`/v1/products/${productId}`)
        .then(response => {
  ...
  promoteProduct() {
    ...
    this.setState({
      ...
      this.submitFormDataFetcher = dispatch(
        fetchAuthorizedApiRequest(`/v1/products/${productId}/promotions`, {
          method: 'POST',
          headers: {
  ...
  getWidgetTitle() {
    return (
      this.I18n.t('administration.form.promote') + this.I18n.t('administration.menuDropDown.product')
    );
  }
