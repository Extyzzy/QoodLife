...
export function pdfGenerate(invoiceUser) {
  const saveLocale = moment.unix(invoiceUser.charges.data[0].created).format("MMM DD, YYYY");
      ...
      <Page size="A4" style={style.body}>
        ...
        <View style={style.top}>
          <View>
            ...
            <Text style={style.name}>
              {invoiceUser.customer.metadata.firstName} {invoiceUser.customer.metadata.lastName}
            </Text>
            <Text style={style.header}>{invoiceUser.customer.metadata.company}</Text>
            <Text style={style.header}>
              {invoiceUser.customer.metadata.streetAddress}
            </Text>
            <Text style={style.header}>
              {invoiceUser.customer.metadata.countryCodeAlpha2},{' '}
              {invoiceUser.customer.metadata.postalCode}
            </Text>
            <Text style={style.header} />
          </View>
          ...
          <View style={style.rightMoney}>
            <Text style={style.money}>
              {invoiceUser.charges.data[0].amount}
            </Text>
          </View>
        ...
        <View style={style.tableContainer}>
          ...
          <View style={style.tableAmountData}>
            <Text>{invoiceUser.charges.data[0].amount}</Text>
          </View>
        </View>
        ...
        <View style={style.bottomContainer}>
          ...
          <Text style={style.paymentsDataCard}>
            {invoiceUser.charges.data[0].amount} Payment from{' '}
            {invoiceUser.charges.data[0].source.brand} ***{' '}
            {invoiceUser.charges.data[0].source.last4}
          </Text>
