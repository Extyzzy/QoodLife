        ...
        <div className={s.root}>
          ...
          <p>
            The following terms and conditions (collectively, these "Terms and Conditions") apply to your use of
             <span class="website_url">http://qood.life
             </span>, including any content, functionality and services offered on or via <span class="website_url">http://qood.life
             </span> (the "Website").
          </p>

          <p>Please read the Terms and Conditions carefully before you start using
            <span class="website_name">qood.life</span>, because by using the Website you accept and agree to be bound and abide by these
            Terms and Conditions.
          </p>

          <p>These Terms and Conditions are effective as of <span class="date">October 05, 2018</span>.
            We expressly reserve the right to change these Terms and Conditions from time to time without notice to you.
            You acknowledge and agree that it is your responsibility to review this Website and these Terms and Conditions
            from time to time and to familiarize yourself with any modifications. Your continued use of
            this Website after such modifications will constitute acknowledgement of the modified Terms and Conditions and agreement
            to abide and be bound by the modified Terms and Conditions.
          </p>

          <h3>Conduct on Website</h3>

          <p>Your use of the Website is subject to all applicable laws and regulations,
            and you are solely responsible for the substance of your communications through the Website.
          </p>

          <p>By posting information in or otherwise using any communications service,
            chat room, message board, newsgroup, software library, or other interactive
            service that may be available to you on or through this Website,
            you agree that you will not upload, share, post, or otherwise distribute or facilitate distribution of any content — including text,
          ...
          <p>By accepting these Terms and Conditions, you acknowledge and agree that all content presented to you on this Website is protected by copyrights, trademarks, service marks, patents or other proprietary rights and laws, and is the sole property of <span class="website_name">qood.life</span>.</p>
          ...
          <p>Your use of <span class="website_name">qood.life</span> is at your sole risk. The Website is provided "as is" and "as available". We disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement.</p>

          <p>We are not liable for damages, direct or consequential, resulting from your use of the Website, and you agree to defend, indemnify and hold us harmless from any claims, losses, liability costs and expenses (including but not limites to attorney's fees) arising from your violation of any third-party's rights. You acknowledge that you have only a limited, non-exclusive, nontransferable license to use the Website. Because the Website is not error or bug free, you agree that you will use it carefully and avoid using it ways which might result in any loss of your or any third party property or information.</p>

          <h3>Term and termination</h3>

          <p>This Terms and Conditions will become effective in relation to you when you create a <span class="website_name">qood.life</span> account or when you start using the <span class="website_name">qood.life</span> and will remain effective until terminated by you or by us. </p>

          <p><span class="website_name">qood.life</span> reserves the right to terminate this Terms and Conditions or suspend your account at any time in case of unauthorized, or suspected unauthorized use of the Website whether in contravention of this Terms and Conditions or otherwise. If <span class="website_name">qood.life</span> terminates this Terms and Conditions, or suspends your  account for any of the reasons set out in this section, <span class="website_name">qood.life</span> shall have no liability or responsibility to you.</p>

          <h3>Assignment</h3>

          <p><span class="website_name">qood.life</span> may assign this Terms and Conditions or any part of it without restrictions. You may not assign this Terms and Conditions or any part of it to any third party.</p>

          <h3>Governing Law</h3>

          <p>These Terms and Conditions and any dispute or claim arising out of, or related to them, shall be governed by and construed in accordance with the internal laws of the <span class="country">Republic of Moldova</span> without giving effect to any choice or conflict of law provision or rule.</p>

          <p>Any legal suit, action or proceeding arising out of, or related to, these Terms of Service or the Website shall be instituted exclusively in the federal courts of <span class="country">Republic of Moldova</span>.</p>
        </div>
      </Layout>
    );
  }
